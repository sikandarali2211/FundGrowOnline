...
@section('content')
    <style>
        ...
        .cta-section {
            background-image: url('./assets/images/shapes-bg/cta.png');
            height: 100vh;
            background-size: cover;
            /* Desktop ke liye */
            background-position: center;
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-team-image">
                        <img src="{{ asset('assets/images/about/about12.jpg') }}" alt="Team Collaboration"
                            class="img-fluid">
                    </div>
                </div>
            </div>
    ...
    <section class="how-it-works-section pt-120 pb-120" id="howitworks">
        <div class="container">
            ...
            <!-- Desktop Grid -->
            <div class="row text-center justify-content-center mt-5 d-none d-md-flex">
                <!-- Step 1 -->
                <div class="col-md-2 col-6 mb-4 wow fadeInUp">
                    <div class="how-box">
                        ...
                        <p class="how-text">Sign up and choose your starting pool (from just $10).</p>
                    </div>
                </div>
                <!-- Step 2 -->
                <div class="col-md-2 col-6 mb-4 wow fadeInUp">
                    <div class="how-box">
                        ...
                        <p class="how-text">Contribute to the community-driven crowdfunding pool.</p>
                    </div>
                </div>
                <!-- Step 3 -->
                <div class="col-md-2 col-6 mb-4 wow fadeInUp">
                    <div class="how-box">
                        ...
                        <p class="how-text">Your funds multiply with our 3.6x income plan.</p>
                    </div>
                </div>
                <!-- Step 4 -->
                <div class="col-md-2 col-6 mb-4 wow fadeInUp">
                    <div class="how-box">
                        ...
                        <p class="how-text">Invite others and earn attractive referral bonuses.</p>
                    </div>
                </div>
                <!-- Step 5 -->
                <div class="col-md-2 col-6 mb-4 wow fadeInUp">
                    <div class="how-box">
                        ...
                        <p class="how-text">Withdraw your income quickly and enjoy financial freedom.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-block d-md-none mt-5">
                <div class="owl-carousel owl-theme" id="howCarousel">
                    <!-- Step 1 -->
                    <div class="item text-center">
                        <div class="how-box">
                            <div class="icon-wrap glow-icon"><i class="fas fa-user-plus"></i></div>
                            <h5 class="how-title">JOIN</h5>
                            <p class="how-text">Sign up and choose your starting pool (from just $10).</p>
                        </div>
                    </div>
                    ...
                    <div class="item text-center">
                        <div class="how-box">
                            <div class="icon-wrap glow-icon"><i class="fas fa-coins"></i></div>
                            <h5 class="how-title">FUND</h5>
                            <p class="how-text">Contribute to the community-driven crowdfunding pool.</p>
                        </div>
                    </div>
                    ...
                    <div class="item text-center">
                        <div class="how-box">
                            <div class="icon-wrap glow-icon"><i class="fas fa-chart-line"></i></div>
                            <h5 class="how-title">GROW</h5>
                            <p class="how-text">Your funds multiply with our 3.6x income plan.</p>
                        </div>
                    </div>
                    ...
                    <div class="item text-center">
                        <div class="how-box">
                            <div class="icon-wrap glow-icon"><i class="fas fa-link"></i></div>
                            <h5 class="how-title">REFER</h5>
                            <p class="how-text">Invite others and earn attractive referral bonuses.</p>
                        </div>
                    </div>
                    ...
                    <div class="item text-center">
                        <div class="how-box">
                            <div class="icon-wrap glow-icon"><i class="fas fa-gift"></i></div>
                            <h5 class="how-title">EARN</h5>
                            <p class="how-text">Withdraw your income quickly and enjoy financial freedom.</p>
                        </div>
                    </div>
    ...
    <section class="services-section pt-80 pb-80">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p>Unlock financial growth with our Crowdfunding Plans designed for all levels.</p>
            </div>
            ...
            <div class="row g-4 d-none d-md-flex">
                <div class="col-md-4">
                    <div class="service-card">
                        ...
                        <p>Pools from <strong>$10 to $100,000</strong> with <strong>3.6x growth</strong>.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service-card">
                        <div class="service-icon"><i class="fas fa-chart-line"></i></div>
                        <h4>Dual-phase Income</h4>
                        <p>Instant + long-term multiplication with dual-phase system.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service-card">
                        ...
                        <p>Earn up to <strong>$56,836</strong> by referring others.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-block d-md-none">
                <div class="owl-carousel owl-theme" id="servicesCarousel">
                    <div class="item">
                        <div class="service-card">
                            <div class="service-icon"><i class="fas fa-coins"></i></div>
                            <h4>Flexible Plans</h4>
                            <p>Pools from $10 to $100,000 with 3.6x growth.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="service-card">
                    ...
                    <div class="item">
                        <div class="service-card">
                            <div class="service-icon"><i class="fas fa-user-friends"></i></div>
                            <h4>Referral Rewards</h4>
                            <p>Earn up to $56,836 by referring others.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="contact-content">
                                ...
                                <form class="contact-form" action="#" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="message" name="message" class="form-input form-textarea" rows="5" placeholder="Message"
                                            required></textarea>
                                    </div>
